...
def test_category_basic():
    ...
    budget1.update_category_amount(50, budget1.category_dict["Test1"])
...
def test_build_categories():
    ...
    budget2.build_category_dict(budget1.store_categories())
    assert len(budget2.category_dict) == 3
    assert budget2.category_dict["1"].income == 100.0
    assert budget2.category_dict["2"].income == 200.0
    assert budget2.category_dict['3'].income == 300.0
